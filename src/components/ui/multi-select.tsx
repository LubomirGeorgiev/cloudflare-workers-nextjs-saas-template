...
interface MultiSelectProps
   ...
   * Receives the current search string.
   * Optional, useful for custom search handling or tag creation.
   */
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    // Call onSearchChange callback when search value changes
    React.useEffect(() => {
      if (onSearchChange) {
                        ...
                        return (
                          <Badge
                            ...
                            <div
                              ...
                              className="ml-2 flex items-center justify-center cursor-pointer hover:bg-white/20 rounded-sm focus:outline-none focus:ring-1 focus:ring-white/50">
                              <XCircle
                                className={cn(
                                  "h-3 w-3",
                                  responsiveSettings.compactMode &&
