...
| [docs/page-caching.md](docs/page-caching.md) | Adding or changing `export const revalidate` on a public page, or any `Cache-Control`, `Vary`, or `Cache-Tag` header the Worker sets |
