...
// from `@/i18n/navigation` (the locale-aware Link) instead. Admin pages (and everything else outside `[locale]`) are intentionally untranslated, so they may keep importing `next/link` directly.
